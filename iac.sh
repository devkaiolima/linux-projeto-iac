...
useradd marcos -m -s /bin/bash -p ${openssl passwd -crypt Senha123} -G GPR_VEN
useradd jurandir -m -s /bin/bash -p ${openssl passwd -crypt Senha123} -G GPR_VEN

useradd roberto -m -s /bin/bash -p ${openssl passwd -crypt Senha123} -G GPR_SEC
